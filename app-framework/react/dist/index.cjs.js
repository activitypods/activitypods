 ...
 */ const $88874b19fd1a9965$var$BackgroundChecks = ({ clientId: clientId, children: children }) => {
  ...
  const nodeinfo = (0, $fvx3m$semappsactivitypubcomponents.useNodeinfo)(
    identity?.id ? new URL(identity?.id).host : undefined
  );
      ...
      children: [
        /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)((0, $fvx3m$muimaterial.Box), {
          ...
          children: /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)((0, $fvx3m$muimaterial.Avatar), {
            children: /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)(
              (0, $parcel$interopDefault($fvx3m$muiiconsmaterialLock)),
              {}
            )
          })
        }),
        ...
        /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)((0, $fvx3m$muimaterial.Box), {
          ...
          children: /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)((0, $fvx3m$muimaterial.List), {
            ...
            children: podProviders.map((podProvider, i) =>
              /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsxs)(
                (0, $fvx3m$react.Fragment),
                {
                  children: [
                      ...
                      children: /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsxs)((0, $fvx3m$muimaterial.ListItemButton), {
                        ...
                        children: [
                          /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)((0, $fvx3m$muimaterial.ListItemAvatar), {
                            children: /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)((0, $fvx3m$muimaterial.Avatar), {
                              children: /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)(
                                (0, $parcel$interopDefault($fvx3m$muiiconsmaterialStorage)),
                                {}
                              )
                            })
                          }),
 ...
 */ const $86676b500f2a011a$var$ContactItem = ({
  record: record,
...
/** @typedef {import("./ShareDialog").InvitationState} InvitationState */ const $35582d4b0c1bf8ac$var$useStyles = (0,
$parcel$interopDefault($fvx3m$muistylesmakeStyles))(theme => ({
  listItem: {
    paddingLeft: 0,
    paddingRight: 0
  },
 ...
 * @param {(invitations: Record<string, InvitationState>) => void} props.onChange
 * @param {boolean} props.isCreator
 */ const $35582d4b0c1bf8ac$var$GroupContactsItem = ({
  group: group,
  onChange: onChange,
    ...
    children: [
      /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)((0, $fvx3m$muimaterial.ListItemAvatar), {
        ...
        children: /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)((0, $fvx3m$muimaterial.Avatar), {
          ...
          className: classes.avatar,
          children: /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)(
            (0, $parcel$interopDefault($fvx3m$muiiconsmaterialGroup)),
            {}
          )
        })
      }),
 ...
 * @param {(invitations: Record<string, InvitationState) => void} props.onChange
 * @param {boolean} props.isCreator
 */ const $d4e71d4ba572ee47$var$ContactsShareList = ({
  invitations: invitations,
  onChange: onChange,
  ...
  const profilesFiltered = (0, $fvx3m$react.useMemo)(
    () =>
      profilesData
        ...
        .filter(
          profile =>
            ...
            (0, $f21bc75053423cc3$export$1b2abdd92765429)(profile.describes)
              .toLocaleLowerCase()
  ...
  return /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsxs)((0, $fvx3m$muimaterial.List), {
    ...
    children: [
      ...
      groupsFiltered?.map(group =>
        /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)(
          (0, $35582d4b0c1bf8ac$export$2e2bcd8739ae039),
          {
            group: group,
            invitations: invitations,
            onChange: onChange,
      ...
      profilesFiltered?.map(profile =>
        /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)(
          (0, $86676b500f2a011a$export$2e2bcd8739ae039),
          {
            record: profile,
...
const $8ffb7dd40d703ae5$var$ShareDialog = ({
  close: close,
  ...
  const { items: announcers } = (0, $fvx3m$semappsactivitypubcomponents.useCollection)(
    isCreator ? record?.['apods:announcers'] : undefined
  );
  /** @type {[Record<string, InvitationState>, (invitations: Record<string, InvitationState>) => void]} */ const [
    invitations,
    setInvitations
  ] = (0, $fvx3m$react.useState)({});
  ...
  /** @param {Record<string, InvitationState} changedRights */ const onChange = (0, $fvx3m$react.useCallback)(
    changedRights => {
 ...
 */ const $c30b6e8e8f4f1d51$var$ShareButton = ({
  profileResource: profileResource = 'Profile',
  groupResource: groupResource = 'Group'
}) => {
  const [shareOpen, setShareOpen] = (0, $fvx3m$react.useState)(false);
  const record = (0, $fvx3m$reactadmin.useRecordContext)();
  const { error: error, isLoading: isLoading } = (0, $fvx3m$semappsactivitypubcomponents.useCollection)(
    record?.['apods:announces']
  );
  const translate = (0, $fvx3m$reactadmin.useTranslate)();
  // If the user can see the list of announces, it means he can share
  if (!isLoading && !error)
    return /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsxs)((0, $fvx3m$reactjsxruntime.Fragment), {
      children: [
        /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)((0, $fvx3m$reactadmin.Button), {
          label: translate('apods.action.share'),
          onClick: () => setShareOpen(true),
          children: /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)(
            (0, $parcel$interopDefault($fvx3m$muiiconsmaterialShare)),
            {}
          )
        }),
        shareOpen &&
          /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)((0, $8ffb7dd40d703ae5$export$2e2bcd8739ae039), {
            ...
            (0, $fvx3m$muimaterial.MenuItem),
            {
              ...
              children: [
                /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)((0, $fvx3m$muimaterial.ListItemIcon), {
                  children: /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)(
                    (0, $parcel$interopDefault($fvx3m$muiiconsmaterialPeopleAlt)),
                    {}
                  )
                }),
                /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)((0, $fvx3m$muimaterial.ListItemText), {
          ...
          /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsxs)(
            (0, $fvx3m$muimaterial.MenuItem),
            {
              ...
              children: [
                /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)((0, $fvx3m$muimaterial.ListItemIcon), {
                  children: /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)(
                    (0, $parcel$interopDefault($fvx3m$muiiconsmaterialApps)),
                    {}
                  )
                }),
                /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)((0, $fvx3m$muimaterial.ListItemText), {
          ...
          /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsxs)(
            (0, $fvx3m$muimaterial.MenuItem),
            {
              ...
              children: [
                /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)((0, $fvx3m$muimaterial.ListItemIcon), {
                  children: /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)(
                    (0, $parcel$interopDefault($fvx3m$muiiconsmaterialSettings)),
                    {}
                  )
                }),
                /*#__PURE__*/ (0, $fvx3m$reactjsxruntime.jsx)((0, $fvx3m$muimaterial.ListItemText), {
