import {
  useState as $iLwJW$useState,
  useCallback as $iLwJW$useCallback,
  useEffect as $iLwJW$useEffect,
  useLayoutEffect as $iLwJW$useLayoutEffect,
  Fragment as $iLwJW$Fragment,
  useMemo as $iLwJW$useMemo
} from 'react';
import $iLwJW$urljoin from 'url-join';
import {
  useGetIdentity as $iLwJW$useGetIdentity,
  useNotify as $iLwJW$useNotify,
  useLocaleState as $iLwJW$useLocaleState,
  useLogin as $iLwJW$useLogin,
  useLogout as $iLwJW$useLogout,
  useTranslate as $iLwJW$useTranslate,
  useRedirect as $iLwJW$useRedirect,
  useRecordContext as $iLwJW$useRecordContext,
  Button as $iLwJW$Button,
  useGetList as $iLwJW$useGetList,
  UserMenu as $iLwJW$UserMenu,
  Logout as $iLwJW$Logout,
  MenuItemLink as $iLwJW$MenuItemLink
} from 'react-admin';
import {
  useNodeinfo as $iLwJW$useNodeinfo,
  useCollection as $iLwJW$useCollection,
  useOutbox as $iLwJW$useOutbox,
  ACTIVITY_TYPES as $iLwJW$ACTIVITY_TYPES
...
import {
  Box as $iLwJW$Box,
  Card as $iLwJW$Card,
  Avatar as $iLwJW$Avatar,
  Typography as $iLwJW$Typography,
  List as $iLwJW$List,
  Divider as $iLwJW$Divider,
  ListItem as $iLwJW$ListItem,
  ListItemButton as $iLwJW$ListItemButton,
  ListItemAvatar as $iLwJW$ListItemAvatar,
  ListItemText as $iLwJW$ListItemText,
  useMediaQuery as $iLwJW$useMediaQuery,
  Dialog as $iLwJW$Dialog,
  DialogTitle as $iLwJW$DialogTitle,
  DialogContent as $iLwJW$DialogContent,
  DialogActions as $iLwJW$DialogActions,
  Button as $iLwJW$Button1,
  TextField as $iLwJW$TextField,
  CircularProgress as $iLwJW$CircularProgress,
  Switch as $iLwJW$Switch,
  MenuItem as $iLwJW$MenuItem,
  ListItemIcon as $iLwJW$ListItemIcon
} from '@mui/material';
        ...
        if (response.ok) {
          ...
          if (appStatus) {
            ...
            if (!appStatus.onlineBackend)
              notify(`The app backend is offline`, {
                type: 'error'
              });
            else if (!appStatus.installed)
              notify(`The app is not installed`, {
                type: 'error'
              });
    ...
    (async () => {
      if (podProviders.length < 1) {
        ...
        if (results.ok) {
          ...
          notify('auth.message.pod_providers_not_loaded', {
            type: 'error'
          });
      }
    })();
  ...
  (0, $iLwJW$useEffect)(() => {
    if (dataModels) {
      ...
      if (searchParams.has('uri'))
        navigate(
          `/${resource}/${encodeURIComponent(searchParams.get('uri'))}${searchParams.get('mode') === 'show' ? '/show' : ''}`
        );
 ...
 */ const $3d109438326dd070$var$ContactItem = ({
  record: record,
...
/** @typedef {import("./ShareDialog").InvitationState} InvitationState */ const $c78c4dd8a63b7af2$var$useStyles = (0,
$iLwJW$muistylesmakeStyles)(theme => ({
  listItem: {
    paddingLeft: 0,
    paddingRight: 0
  },
 ...
 * @param {(invitations: Record<string, InvitationState>) => void} props.onChange
 * @param {boolean} props.isCreator
 */ const $c78c4dd8a63b7af2$var$GroupContactsItem = ({
  group: group,
  onChange: onChange,
  ...
  const switchShare = (0, $iLwJW$useCallback)(() => {
    ...
    const newInvitations = Object.fromEntries(
      groupMemberIds
        .map(memberId => {
          if (invitations[memberId]?.shareReadonly) return [undefined, undefined];
          else {
  ...
  const switchView = (0, $iLwJW$useCallback)(() => {
    ...
    const newInvitations = Object.fromEntries(
      groupMemberIds
        .map(memberId => {
          if (invitations[memberId]?.viewReadonly) return [undefined, undefined];
          else {
 ...
 * @param {(invitations: Record<string, InvitationState) => void} props.onChange
 * @param {boolean} props.isCreator
 */ const $353d7b2d3f8a843f$var$ContactsShareList = ({
  invitations: invitations,
  onChange: onChange,
  ...
  const profilesFiltered = (0, $iLwJW$useMemo)(
    () =>
      profilesData
        ...
        .filter(
          profile =>
            ...
            (0, $93d7a9f3166de761$export$1b2abdd92765429)(profile.describes)
              .toLocaleLowerCase()
  ...
  return /*#__PURE__*/ (0, $iLwJW$jsxs)((0, $iLwJW$List), {
    ...
    children: [
      ...
      groupsFiltered?.map(group =>
        /*#__PURE__*/ (0, $iLwJW$jsx)(
          (0, $c78c4dd8a63b7af2$export$2e2bcd8739ae039),
          {
            group: group,
            invitations: invitations,
            onChange: onChange,
      ...
      profilesFiltered?.map(profile =>
        /*#__PURE__*/ (0, $iLwJW$jsx)(
          (0, $3d109438326dd070$export$2e2bcd8739ae039),
          {
            record: profile,
...
const $79f089d541db8101$var$ShareDialog = ({
  close: close,
  resourceUri: resourceUri,
  profileResource: profileResource = 'Profile',
  groupResource: groupResource = 'Group'
}) => {
  ...
  /** @type {[Record<string, InvitationState>, (invitations: Record<string, InvitationState>) => void]} */ const [
    invitations,
    setInvitations
  ] = (0, $iLwJW$useState)({});
  ...
  /** @param {Record<string, InvitationState} changedRights */ const onChange = (0, $iLwJW$useCallback)(
    changedRights => {
 ...
 */ const $47fb439769024aa7$var$ShareButton = ({
  profileResource: profileResource = 'Profile',
  groupResource: groupResource = 'Group'
}) => {
  ...
  if (!isLoading && !error)
    return /*#__PURE__*/ (0, $iLwJW$jsxs)((0, $iLwJW$Fragment1), {
      children: [
        ...
        shareOpen &&
          /*#__PURE__*/ (0, $iLwJW$jsx)((0, $79f089d541db8101$export$2e2bcd8739ae039), {
...
const $f86de5ead054b96d$var$UserMenu = () => {
  const { data: identity } = (0, $iLwJW$useGetIdentity)();
  const nodeinfo = (0, $iLwJW$useNodeinfo)(
...
export {
  $2957839fe06af793$export$2e2bcd8739ae039 as BackgroundChecks,
  $e235591816215308$export$2e2bcd8739ae039 as PodLoginPage,
  $1a88c39afebe872d$export$2e2bcd8739ae039 as RedirectPage,
  $47fb439769024aa7$export$2e2bcd8739ae039 as ShareButton,
  $79f089d541db8101$export$2e2bcd8739ae039 as ShareDialog,
  $f86de5ead054b96d$export$2e2bcd8739ae039 as UserMenu,
  $4b2a6afceae7f301$export$2e2bcd8739ae039 as englishMessages,
  $5de716308b366acb$export$2e2bcd8739ae039 as frenchMessages
};
