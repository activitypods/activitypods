...
export const REDIS_REDIRECT_URL = process.env.SEMAPPS_REDIS_REDIRECT_URL;
...
export const SMTP_PORT = process.env.SEMAPPS_SMTP_PORT && parseInt(process.env.SEMAPPS_SMTP_PORT, 10);
