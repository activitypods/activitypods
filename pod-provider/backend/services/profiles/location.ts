...
const ProfilesLocationServiceSchema = {
...
export default ProfilesLocationServiceSchema;

declare global {
  export namespace Moleculer {
    export interface AllServices {
      [ProfilesLocationServiceSchema.name]: typeof ProfilesLocationServiceSchema;
    }
  }
}
