...
export default AuthAgentServiceSchema;

declare global {
  export namespace Moleculer {
    export interface AllServices {
      [AuthAgentServiceSchema.name]: typeof AuthAgentServiceSchema;
    }
  }
}
