...
excerpt: 'ActivityPods is built on top of SemApps, a toolkit for developing semantic web applications that dates back to the early 2010s. The technological choices that have guided and continue to guide the development of ActivityPods are intimately linked to SemApps and its philosophy.'
...
[SemApps](https://semapps.org) (for Semantic Applications) was created within Virtual Assembly, a french non-profit association founded in 2011, which was initially conceived as a citizen think-tank.
...
<ImageCaption src={grandsVoisins} label="The first instance of SemApps for Les Grands Voisins" />
...
<ImageCaption src={moleculerServices} label="Moleculer services in SemApps applications" />
