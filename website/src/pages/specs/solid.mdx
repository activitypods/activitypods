...
- Authorization flow is handled using ActivityPub, with a simple `Register` activity and not with Solid.
...
See https://solid.github.io/notifications/websocket-channel-2023
